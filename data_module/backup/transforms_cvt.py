...
class SaveDataTransform:
    ...
    def get_cameras(self, batch: Sample):
        return {
            ...
            'sensor2ego_mats': batch.sensor2ego_mats,
            'ego2global_rotation': batch.ego2global_rotation,
            'ego2global_translation': batch.ego2global_translation,
            'librated_sensor': batch.lidar_calibrated_sensor,
            'lidar_ego_pose': batch.lidar_ego_pose,
            'cam_calibrated_sensors' : batch.cam_calibrated_sensors,
            'cam_ego_poses' : batch.cam_ego_poses,
        }
    ...
    def get_3d_det(self, batch):
        return {'gt_boxes': batch.gt_boxes, 'gt_labels': batch.gt_labels}
