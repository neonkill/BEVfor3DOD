...
from model_module.model.segmentation.matching import TransformerDecoderLayer
'''
...
class SemanticFeatureExtractor(torch.nn.Module):
    ...
    def __init__(self, bev_embedding, image_height, image_width, 
        ...
        self.match = TransformerDecoderLayer(d_model=embed_dims, 
                                            nhead=n_head, 
    ...
    def forward(self, x, I, E):
        ...
        img_embed = rearrange(img_embed, '(b n) d h w -> b (n h w) d', b=b, n=n)          # b (n H W) c
        ...
        # matching
        query = self.match(query, kv+img_embed, kv)                             # b (16*16) 64
        ...
        return self.up(query)                                                   # b 64 128 128
