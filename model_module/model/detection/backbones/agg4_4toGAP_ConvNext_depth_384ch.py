...
import torchvision
from ..modules import Aggregator_LN_GELU, Aggregator_LN_GELU_NoReduce, ConvBlock, LayerNorm, ConvNeXtBlock
...
class Backbone(nn.Module):
    def __init__(self, 
        ...
        self.reduce_bev = Aggregator_LN_GELU_NoReduce(reduce_dim, bev_chs, target_idx=0)
        self.reduce_depth = Aggregator_LN_GELU(reduce_dim, depth_chs, target_idx=0)
        self.reduce_seg = Aggregator_LN_GELU(reduce_dim, bev_chs, target_idx=0)
