...
class Matching(nn.Module):
    def __init__(
        ...
        if (image_height == 224) or (image_height == 256):
    ...
    def forward(self, img_feat, I, E):
        ...
        Input:
            img_feat: 1/128 feature from image (6b, 128, h/128, w/128)
        ...
        val_flat = self.val_linear(img_feat)                                    # (b n) d H W
        ...
        # print(pixel_flat.shape, I_inv.shape)
        ...
        key_flat = img_embed + self.key_linear(img_feat)
